  ...
  return (
    <>
      ...
      <Box>
        ...
        >I confirm that {guests.fullName} had paid the total amount of {!addBreakfast ? formatCurrency(totalPrice) :
          `${formatCurrency(totalPrice + optBreakFastPrice)}(${formatCurrency(totalPrice)}+${formatCurrency(optBreakFastPrice)})`}</Checkbox>
      </Box>
